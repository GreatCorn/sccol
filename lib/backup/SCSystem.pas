...
begin
  ...
  SCNotEq := PChar(EndResult);
         ...
         { PARAMETERS }
function SCR:pchar; begin SCR := PChar(StringReplace(FloatToStr(Random), ',', '.', [rfReplaceAll])) end;
...
function SCEnd(var SH: TSharedObject; ARGUMENTS: array of pchar):pchar;
var
  I: word;
begin
...
function SCGet(var SH: TSharedObject; ARGUMENTS: array of pchar):pchar;
var
  Value: ansistring;
begin
  ReadLn(Value);
...
exports
  ...
  SCR,
  SCAbs, SCACall, SCCall, SCEnd, SCFree, SCFunc, SCGet, SCIf, SCIsNaN, SCMem, SCRand, SCResult, SCSay, SCSet, SCWait;
end.
